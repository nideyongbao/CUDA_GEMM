...
//
// 派发从"数组下标即 id"改成"显式 id + 线性查表(tc_find)"：因为架构门控会从数组中间
// 摘掉 tc_04/05(Hopper 独占)，若仍用 TC_CASES[id-1]，Ampere 上 id=6 会越界/错位。
// 现在 id 跨架构稳定：tc_06(sm_80+ 通用 mma.sync)永远是 id=6，无论 tc_04/05 在不在。
// ============================================================================
#include <cstdio>
