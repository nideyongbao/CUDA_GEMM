...
>
> 分支：`feat/a800-reproduction`。原 H20 收口见 [docs/13](13%20H20%20GEMM%20复现总结.md)。
...
- **cuBLAS 越大越满**：FP32 8192³ 吃到峰值 **98.4%**；BF16 8192³ 吃到 312T 的 **94.4%（294.6T）**——确认 312T 峰值正确、cuBLAS 几乎打满。
