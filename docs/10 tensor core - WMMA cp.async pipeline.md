...
## 1、观大局
```
sudo /usr/local/cuda/bin/ncu --set full -k regex:"wmma_pipe_kernel" -s 1 -c 1 ./kernels/tensor_core/bench 3 2048 2048 2048
```
...
smsp__average_warps_issue_stalled_barrier_per_issue_active.ratio \
  -k regex:"wmma_pipe_kernel" -s 1 -c 1 ./kernels/tensor_core/bench 3 2048 2048 2048
```
